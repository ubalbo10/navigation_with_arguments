...
import com.example.prueba_navigation.databinding.FragmentSegundoBinding
...
class segundoFragment : Fragment() {
    ...
    var _binding : FragmentSegundoBinding ?= null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val arg= segundoFragmentArgs.fromBundle(bundle)

        if(arg.numero!=null){
            binding.textFragmen2.text=arg.numero
        }



        binding.btnHome.setOnClickListener {
            findNavController().navigate(R.id.action_segundoFragment_to_homeFragment)
